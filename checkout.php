      ...
      <div class="col-md-5 col-lg-4 order-md-last">
        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
            <div class="col-12">
              <div class="col-4"><img class="d-block mx-auto mb-4" src="img/<?=$data['foto']?>" width="180" height="150" alt=""></div>
            </div>
            <input type="hidden" name="id_barang" value="<?=$idbar?>">
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <span>Total (RP)</span>
            <strong><?=number_format($data['harga_barang'])?></strong>
          </li>
        </ul>
