            ...
            <div class="col-md-12">
              <div class="row row-cols-md-3 row-cols-sm-2 p-5">
                ...
                <div class="card" style="width: 18rem;">
                  <img src="img/<?php echo $result['foto']?>" width="100px" height="300px" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title"><?php echo $result['nama_barang']?></h5>
                    <p class="card-text">Rp.<?php echo number_format($result['harga_barang'])?></p>
                    <a href="checkout.php?id=<?=$result['id_barang']?>" class="btn btn-primary">Buy Now</a>
                    <a href="cartt.php?id=<?=$result['id_barang']?>" class="btn btn-primary">Cart</a>
                  </div>
                </div>
                </div>
                <?php } ?>
